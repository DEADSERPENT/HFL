...
const initialClients: ClientNode[] = [
  {
    ...
    accuracy: 0.611, loss: 0.921, datasetSize: 796, nTrain: 557, nVal: 119, nTest: 120,
    lastUpdate: Date.now(), status: 'active', latency: 43, localRounds: 0,
    classDist: { NORM: 0, MI: 3, STTC: 117, CD: 595, HYP: 81 },
    dominantClass: 'CD', gradientNorm: 0.241, epsilonSpent: 0,
  },
  {
    id: 'device_01', name: 'HC-A2', edgeId: 0,
    accuracy: 0.578, loss: 0.963, datasetSize: 317, nTrain: 221, nVal: 47, nTest: 49,
    lastUpdate: Date.now(), status: 'active', latency: 61, localRounds: 0,
    classDist: { NORM: 54, MI: 5, STTC: 247, CD: 3, HYP: 8 },
    dominantClass: 'STTC', gradientNorm: 0.298, epsilonSpent: 0,
  },
  {
    id: 'device_02', name: 'HC-A3', edgeId: 0,
    accuracy: 0.633, loss: 0.856, datasetSize: 992, nTrain: 694, nVal: 148, nTest: 150,
    lastUpdate: Date.now(), status: 'active', latency: 37, localRounds: 0,
    classDist: { NORM: 141, MI: 362, STTC: 428, CD: 45, HYP: 16 },
    dominantClass: 'STTC', gradientNorm: 0.204, epsilonSpent: 0,
  },
  {
    id: 'device_03', name: 'HC-B1', edgeId: 1,
    accuracy: 0.604, loss: 0.934, datasetSize: 1090, nTrain: 763, nVal: 163, nTest: 164,
    lastUpdate: Date.now(), status: 'active', latency: 55, localRounds: 0,
    classDist: { NORM: 116, MI: 33, STTC: 7, CD: 121, HYP: 813 },
    dominantClass: 'HYP', gradientNorm: 0.263, epsilonSpent: 0,
  },
  {
    id: 'device_04', name: 'HC-B2', edgeId: 1,
    accuracy: 0.619, loss: 0.899, datasetSize: 766, nTrain: 536, nVal: 114, nTest: 116,
    lastUpdate: Date.now(), status: 'idle', latency: 72, localRounds: 0,
    classDist: { NORM: 394, MI: 250, STTC: 21, CD: 22, HYP: 79 },
    dominantClass: 'NORM', gradientNorm: 0.237, epsilonSpent: 0,
  },
  {
    id: 'device_05', name: 'HC-B3', edgeId: 1,
    accuracy: 0.641, loss: 0.844, datasetSize: 1039, nTrain: 727, nVal: 155, nTest: 157,
    lastUpdate: Date.now(), status: 'active', latency: 48, localRounds: 0,
    classDist: { NORM: 295, MI: 347, STTC: 180, CD: 214, HYP: 3 },
...
export const useFLStore = create<FLState>((set) => ({
  ...
  logs: [
    { id: 'b1', timestamp: Date.now() - 8000, type: 'info',    source: 'System',    message: 'HFL-MM-HC runtime initialized — PTB-XL + Kermany CXR pipeline ready' },
    ...
    { id: 'b3', timestamp: Date.now() - 6000, type: 'info',    source: 'Data',      message: 'Partition loaded — 5,000 samples · Dirichlet α=0.5 · 5 ECG classes (NORM/MI/STTC/CD/HYP)' },
  ...
  experiments: [
      ...
      { aggregation: 'MOON', sparsity: 0, privacyBudget: 0 }),
    {
      ...
      startTime: Date.now(),
      hyperparams: {
        learningRate: 1e-3, rounds: 15, tauE: 3, clientsPerRound: 6,
        aggregation: 'FedProx', localEpochs: 5, batchSize: 64,
      ...
      description: 'Our novel model: FedMamba-HC ECG encoder (IP-1) + MobileNetV3 CXR + FedConform-HC (IP-9) conformal prediction. Two-tier HFL: 6 devices → 2 edges → 1 cloud. DP-SGD ε=1.0 + Top-20% sparsification + INT8 (20× compression). QoS target: Acc ≥83%, AUC ≥0.85, ε≤1.0, P95 latency <100ms.',
